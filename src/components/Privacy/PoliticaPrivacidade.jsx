...
export default function PoliticaPrivacidade({togglePoliticaVisibility}) {
    return (
        <div className="w-full h-screen -mx-2 bg-jet/70 flex justify-center items-center absolute">
            <div className="sm:w-2/3 sm:max-h-[66%] h-[100%] p-2 py-6 bg-eerieBlack shadow-s-input-box text-seaSalt sm:rounded-3xl">
                ...
                <div className=" p-6 overflow-y-auto sm:h-96 h-[90%]">
                    ...
                    <Paragraph title={"Armazenamento de Dados"}>
                        <p>Os dados gerados a partir do uso do nosso serviço podem ser armazenados temporariamente no servidor e localmente. Se você desejar que seus dados sejam excluídos, apague utilizando a opção de "lixeira".</p>
                    </Paragraph>
